/decl/slime_colour/yellow
	...
	baby_icon =    'icons/mob/slimes/slime_baby_yellow.dmi'
	adult_icon =   'icons/mob/slimes/slime_adult_yellow.dmi'
	extract_icon = 'icons/mob/slimes/slime_extract_yellow.dmi'
