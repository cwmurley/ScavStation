/decl/slime_colour/dark_blue
	...
	baby_icon =    'icons/mob/slimes/slime_baby_darkblue.dmi'
	adult_icon =   'icons/mob/slimes/slime_adult_darkblue.dmi'
	extract_icon = 'icons/mob/slimes/slime_extract_darkblue.dmi'
