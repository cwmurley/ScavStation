/decl/slime_colour/purple
	...
	baby_icon =    'icons/mob/slimes/slime_baby_purple.dmi'
	adult_icon =   'icons/mob/slimes/slime_adult_purple.dmi'
	extract_icon = 'icons/mob/slimes/slime_extract_purple.dmi'
