/decl/slime_colour/quantum
	name = "quantum"
	baby_icon =      'icons/mob/slimes/slime_baby_quantum.dmi'
	adult_icon =     'icons/mob/slimes/slime_adult_quantum.dmi'
	extract_icon =   'icons/mob/slimes/slime_extract_quantum.dmi'
