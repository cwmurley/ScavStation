/decl/slime_colour/dark_purple
	...
	baby_icon =    'icons/mob/slimes/slime_baby_darkpurple.dmi'
	adult_icon =   'icons/mob/slimes/slime_adult_darkpurple.dmi'
	extract_icon = 'icons/mob/slimes/slime_extract_darkpurple.dmi'
