/decl/slime_colour/cerulean
	name = "cerulean"
	baby_icon =    'icons/mob/slimes/slime_baby_cerulean.dmi'
	adult_icon =   'icons/mob/slimes/slime_adult_cerulean.dmi'
	extract_icon = 'icons/mob/slimes/slime_extract_cerulean.dmi'
