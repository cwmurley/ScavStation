/decl/slime_colour/light_pink
	name = "light pink"
	baby_icon =    'icons/mob/slimes/slime_baby_lightpink.dmi'
	adult_icon =   'icons/mob/slimes/slime_adult_lightpink.dmi'
	extract_icon = 'icons/mob/slimes/slime_extract_lightpink.dmi'
