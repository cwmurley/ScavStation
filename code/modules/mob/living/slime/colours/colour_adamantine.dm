/decl/slime_colour/adamantine
	name = "adamantine"
	baby_icon =    'icons/mob/slimes/slime_baby_adamantine.dmi'
	adult_icon =   'icons/mob/slimes/slime_adult_adamantine.dmi'
	extract_icon = 'icons/mob/slimes/slime_extract_adamantine.dmi'
