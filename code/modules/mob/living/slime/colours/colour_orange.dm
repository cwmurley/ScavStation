/decl/slime_colour/orange
	...
	baby_icon =    'icons/mob/slimes/slime_baby_orange.dmi'
	adult_icon =   'icons/mob/slimes/slime_adult_orange.dmi'
	extract_icon = 'icons/mob/slimes/slime_extract_orange.dmi'
